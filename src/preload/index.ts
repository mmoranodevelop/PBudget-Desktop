...
const api: BudgetApi = {
  ...
  reportYear: (year, accountId) => invoke('report:year', year, accountId),
  ...
  budgetGet: (year, accountId) => invoke('budget:get', year, accountId),
  budgetSet: (year, accountId, categoryId, month, amount) => invoke('budget:set', year, accountId, categoryId, month, amount),
  budgetVsActual: (year, month, accountId) => invoke('budget:vsActual', year, month, accountId),
  budgetCopyFromActual: (year, sourceYear, accountId) => invoke('budget:copyFromActual', year, sourceYear, accountId),
  dashboard: (year, accountId) => invoke('dashboard:stats', year, accountId),
  forecast: (year, accountId, adjustments) => invoke('forecast:get', year, accountId, adjustments),
  forecastScenarioList: (year, accountId) => invoke('forecastScenario:list', year, accountId),
  forecastScenarioCreate: (input) => invoke('forecastScenario:create', input),
  forecastScenarioUpdate: (id, patch) => invoke('forecastScenario:update', id, patch),
  forecastScenarioDelete: (id) => invoke('forecastScenario:delete', id),
